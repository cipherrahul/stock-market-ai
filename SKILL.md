...
- [Fleet Architecture & Port Matrix](.agents/skills/sovereign-financial-agent/references/fleet_architecture.md)
- [Operational Runbooks (Start/Stop/Migrate)](.agents/skills/sovereign-financial-agent/references/operational_runbooks.md)
- [Troubleshooting & Remediation Matrix](.agents/skills/sovereign-financial-agent/references/troubleshooting_matrix.md)
...
4. **Health Check Fleet**:
   Execute the PowerShell health sweep in [Operational Runbooks](.agents/skills/sovereign-financial-agent/references/operational_runbooks.md#4-health-verification--telemetry).
